...
public class GameManager {
	...
	public String setMapMaxy(Player p, String mapName) {
		...
		if(StorageManager.getInstance().getStorage().saveMap(currentMap))
			return ChatColor.GREEN + "Set " + mapName + "'s maximum Y to your Y & saved to config";
		else
			return ChatColor.RED + "Set " + mapName + "'s maximum Y location to your location but couldn't save it to config";
	}
